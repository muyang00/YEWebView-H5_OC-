...
#import "YEWKWebViewStyleVC.h"

@interface YEWKWebViewStyleVC ()<WKScriptMessageHandler, WKNavigationDelegate, WKUIDelegate>
...
@implementation YEWKWebViewStyleVC
...
- (void)setupWKWebView{
    ...
    NSURL *path = [[NSBundle mainBundle] URLForResource:@"test_04" withExtension:@"html"];
...
- (void)userContentController:(WKUserContentController *)userContentController
    ...
    if ([message.name isEqualToString:@"YEAppModel"]) {
        // 打印所传过来的参数，只支持NSNumber, NSString, NSDate, NSArray,
        // NSDictionary, and NSNull类型
        NSLog(@"WKScriptMessageHandler---------------%@", message.body);
    }
}
...
#pragma mark - 有关JavaScript交互的三个方法
